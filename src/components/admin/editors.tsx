...
export function PromosEditor() {
  ...
  return (
    <div>
      <div className="flex justify-end mb-4"><Button onClick={() => setEditing({ title: "", description: "", category: "Moda", date: "", accent: "coral", emoji: "✨", order: 0, active: true })} size="sm" className="bg-primary hover:bg-primary/90 text-primary-foreground"><Plus className="h-4 w-4 mr-1" />Nueva promoción</Button></div>
...
const SETTING_FIELDS: { key: string; label: string; type?: "text" | "textarea" }[] = [
  ...
  { key: "heroSubtitle", label: "Hero — subtítulo", type: "textarea" }, { key: "heroImage", label: "Hero — imagen" },
